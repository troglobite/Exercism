...
var $author$project$ComplexNumbers$abs = function (z) {
	return _Debug_todo(
		'ComplexNumbers',
		{
			start: {line: 50, column: 5},
			end: {line: 50, column: 15}
		})('Please implement abs.');
};
var $author$project$ComplexNumbers$add = F2(
	function (z1, z2) {
		return _Debug_todo(
			'ComplexNumbers',
			{
...
var $author$project$ComplexNumbers$imaginary = function (z) {
	var _v1 = z.a;
	var y = _v1.b;
	return y;
};
var $author$project$ComplexNumbers$real = function (z) {
	var _v1 = z.a;
	var x = _v1.a;
	return x;
};
var $author$project$ComplexNumbers$Complex = function (a) {
	return {$: 'Complex', a: a};
};
var $author$project$ComplexNumbers$sub = F2(
	function (z1, z2) {
		var _v0 = function () {
			var z = z1.a;
			return z;
		...
		var a = _v2.a;
		var b = _v2.b;
		return $author$project$ComplexNumbers$Complex(
			_Utils_Tuple2(a - c, b - d));
	});
var $elm_explorations$test$Expect$Absolute = function (a) {
	return {$: 'Absolute', a: a};
};
var $author$project$Tests$tolerance = $elm_explorations$test$Expect$Absolute(0.00001);
...
var $author$project$Tests$approximatelyEqual = F2(
	function (z1, z2) {
		return A2(
			...
			_List_fromArray(
				[
					A2(
					$elm$core$Basics$composeR,
					$author$project$ComplexNumbers$real,
					A2($elm_explorations$test$Expect$within, $author$project$Tests$tolerance, 0)),
					A2(
					$elm$core$Basics$composeR,
					$author$project$ComplexNumbers$imaginary,
					A2($elm_explorations$test$Expect$within, $author$project$Tests$tolerance, 0))
				]),
			A2($author$project$ComplexNumbers$sub, z1, z2));
	});
var $author$project$ComplexNumbers$conjugate = function (z) {
	return _Debug_todo(
		'ComplexNumbers',
		{
			start: {line: 45, column: 5},
			end: {line: 45, column: 15}
		})('Please implement conjugate.');
};
var $author$project$ComplexNumbers$div = F2(
	function (z1, z2) {
		return _Debug_todo(
			'ComplexNumbers',
			{
			...
			})('Please implement div.');
	});
var $elm$core$Basics$e = _Basics_e;
var $author$project$ComplexNumbers$exp = function (z) {
	return _Debug_todo(
		'ComplexNumbers',
		{
			start: {line: 83, column: 5},
			end: {line: 83, column: 15}
		})('Please implement exp.');
};
var $author$project$ComplexNumbers$fromPair = function (pair) {
	return $author$project$ComplexNumbers$Complex(pair);
};
var $author$project$ComplexNumbers$fromReal = function (_float) {
	return _Debug_todo(
		'ComplexNumbers',
		{
			start: {line: 28, column: 5},
			end: {line: 28, column: 15}
		})('Please implement fromReal.');
};
var $author$project$ComplexNumbers$mul = F2(
	function (z1, z2) {
		var _v0 = function () {
			var z = z2.a;
			return z;
...
var $author$project$Tests$tests = A2(
	...
	_List_fromArray(
		[
				...
				[
					...
					function (_v0) {
						return A3(
							...
							$author$project$Tests$tolerance,
							1,
							$author$project$ComplexNumbers$real(
								$author$project$ComplexNumbers$fromPair(
									_Utils_Tuple2(1, 0))));
					}),
					A2(
					$elm_explorations$test$Test$test,
			...
			function (_v6) {
				return A2(
					$author$project$Tests$approximatelyEqual,
					$author$project$ComplexNumbers$fromPair(
						_Utils_Tuple2(-1, 0)),
					A2(
						$author$project$ComplexNumbers$mul,
						$author$project$ComplexNumbers$fromPair(
							_Utils_Tuple2(0, 1)),
						$author$project$ComplexNumbers$fromPair(
							_Utils_Tuple2(0, 1))));
								...
								function (_v7) {
									return A2(
										...
										$author$project$ComplexNumbers$fromPair(
											_Utils_Tuple2(3, 0)),
										A2(
											$author$project$ComplexNumbers$add,
											$author$project$ComplexNumbers$fromPair(
												_Utils_Tuple2(1, 0)),
											$author$project$ComplexNumbers$fromPair(
												_Utils_Tuple2(2, 0))));
								...
								function (_v10) {
									return A2(
										...
										$author$project$ComplexNumbers$fromPair(
											_Utils_Tuple2(-1, 0)),
										A2(
											$author$project$ComplexNumbers$sub,
											$author$project$ComplexNumbers$fromPair(
												_Utils_Tuple2(1, 0)),
											$author$project$ComplexNumbers$fromPair(
												_Utils_Tuple2(2, 0))));
								...
								function (_v16) {
									return A2(
										...
										$author$project$ComplexNumbers$fromPair(
											_Utils_Tuple2(0.5, 0)),
										A2(
											$author$project$ComplexNumbers$div,
											$author$project$ComplexNumbers$fromPair(
												_Utils_Tuple2(1, 0)),
											$author$project$ComplexNumbers$fromPair(
												_Utils_Tuple2(2, 0))));
					...
					A2(
						...
						function (_v19) {
							return A3(
								...
								$author$project$Tests$tolerance,
								5,
								$author$project$ComplexNumbers$abs(
									$author$project$ComplexNumbers$fromPair(
										_Utils_Tuple2(5, 0))));
						})),
					$elm_explorations$test$Test$skip(
					...
					A2(
						...
						function (_v24) {
							return A2(
								...
								$author$project$ComplexNumbers$fromPair(
									_Utils_Tuple2(5, 0)),
								$author$project$ComplexNumbers$conjugate(
									$author$project$ComplexNumbers$fromPair(
										_Utils_Tuple2(5, 0))));
						})),
					$elm_explorations$test$Test$skip(
					...
					A2(
						...
						function (_v27) {
							return A2(
								...
								$author$project$ComplexNumbers$fromPair(
									_Utils_Tuple2(-1, 0)),
								$author$project$ComplexNumbers$exp(
									$author$project$ComplexNumbers$fromPair(
										_Utils_Tuple2(0, $elm$core$Basics$pi))));
						})),
					$elm_explorations$test$Test$skip(
					A2(
						$elm_explorations$test$Test$test,
					...
					A2(
						...
						function (_v29) {
							return A2(
								$author$project$Tests$approximatelyEqual,
								$author$project$ComplexNumbers$fromPair(
									_Utils_Tuple2($elm$core$Basics$e, 0)),
								$author$project$ComplexNumbers$exp(
									$author$project$ComplexNumbers$fromPair(
										_Utils_Tuple2(1, 0))));
						})),
						...
						function (_v30) {
							return A2(
								...
								$author$project$ComplexNumbers$exp(
									$author$project$ComplexNumbers$fromPair(
										_Utils_Tuple2(
											A2($elm$core$Basics$logBase, $elm$core$Basics$e, 2),
											$elm$core$Basics$pi))));
						}))
				])),
			A2(
						...
						function (_v31) {
							return A2(
								...
								A2(
									...
									$author$project$ComplexNumbers$fromPair(
										_Utils_Tuple2(1, 2)),
									$author$project$ComplexNumbers$fromReal(5)));
						})),
					$elm_explorations$test$Test$skip(
					A2(
						$elm_explorations$test$Test$test,
						...
						function (_v33) {
							return A2(
								...
								A2(
									...
									$author$project$ComplexNumbers$fromPair(
										_Utils_Tuple2(5, 7)),
									$author$project$ComplexNumbers$fromReal(4)));
						})),
					$elm_explorations$test$Test$skip(
					A2(
						$elm_explorations$test$Test$test,
						...
						function (_v37) {
							return A2(
								...
								A2(
									...
									$author$project$ComplexNumbers$fromReal(10)));
						})),
					$elm_explorations$test$Test$skip(
					A2(
						$elm_explorations$test$Test$test,
...
var pipeFilename = "/tmp/elm_test-93048.sock";
var net = require('net'),
